    ...
    if len(args) >= 1:
        ...
        if val == "off" or val == "no" or val == "0":
            ...
            if amount <= 0:
                ...
                message.reply_text("Antiflood has to be either 0 (disabled), or a number bigger than or equal to 3!")
                return ""
...
*Admin only:*
 - /setflood <int/'no'/'off'>: enables or disables flood control, use numbers greater or equal to 3 to enable.
"""
